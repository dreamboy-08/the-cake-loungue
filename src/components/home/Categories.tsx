...
const Categories = () => {
  const cats = [
    { name: 'Birthday Cakes', designs: '80+', tag: 'Popular', img: 'https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b?w=500&q=80', href: '/menu#birthday-cakes' },
    { name: 'Wedding Cakes', designs: '45+', tag: null, img: 'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=500&q=80', href: '/menu#wedding-cakes' },
    { name: 'Chocolate Cakes', designs: '60+', tag: 'Bestseller', img: 'https://images.unsplash.com/photo-1548365328-8c6db3220e4c?w=500&q=80', href: '/menu#chocolate-cakes' },
